...
<h1 align="center">
  <img alt="Layout" src="./github/main-image/logo/yummy.png">
</h1>
<br/>
<h1 align="center">
  <img alt="Layout" src="./github/main-image/gif/yummy-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the Yummy project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for Yummy project
</h3>
...
<p align="center">Yummy - The hottest dishes you can find here.</p>

This api is manage Yummy app, developed with Typescript, NodeJs, Express, TypeORM, Postgres e JWT.
...
```bash
$ git clone https://github.com/vynnydev/yummy.git && cd yummy
...
```bash
# Clone your fork
$ git clone your-fork-url && cd yummy
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for Yummy project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/yummy-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/yummy-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/reset-password/yummy-reset-password.png">
</p>
...
<h3 align="center">
  React Native Application for YouHealth project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/yummy-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/vynnydev/yummy_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/vynnydev/yummy.git && cd yummy_mob
OR 
$ git clone https://github.com/vynnydev/yummy_mobile.git
...
$ gh repo fork vynnydev/yummy_mobile
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd yummy_mobile
